...
function setup() {
    ...
    fetch('http://localhost:5050/PingPong')
...
async function sendScore(point) {
    ...
    console.log('Sent!');
    fetch('http://localhost:8080/PingPong',request);
}
...
async function getFinalScore(point) {
    let message = { content: "Final score"};
    let request = {
        method: "GET", 
        headers: {
